...
(function ($) {
   ...
   // let timerInterval;
    ...
    //////////////////////////////////////////  timer deal End
    //$(".categories__deal__countdown__timer").each(function () {
    //    debugger;
    //        const $this = $(this);
    //        const deadline = $this.data("deadline"); // <- get the dynamic date
    ...
    //                "<div class='cd-item'><span>" + event.strftime('%H') + "</span><p>Hours</p></div>" +
    //                "<div class='cd-item'><span>" + event.strftime('%M') + "</span><p>Minutes</p></div>" +
    //                "<div class='cd-item'><span>" + event.strftime('%S') + "</span><p>Seconds</p></div>"
    //            );
    //        });
    //    });
